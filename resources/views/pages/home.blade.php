...
<section>
    ...
    @include('include.product.product-slide', ['list_title' => 'Laptop mới', 'product_type' => 'categories/laptop-moi', 'products' => $new_products, 'price_filter' => true])

    @include('include.product.product-slide', ['list_title' => 'Laptop cũ', 'product_type' => 'categories/laptop-cu', 'products' => $old_products, 'price_filter' => true])

    @include('include.product.product-slide', ['list_title' => 'Máy in', 'product_type' => 'categories/may-in', 'products' => $printers, 'price_filter' => true])
