    ...
    public function run()
    {
        Post::insert([
            ...
            [
                ...
                'slug' => '',
                'description' => 'Khách hàng thân thiết',
                'content' => '<p>Thienthanh dịch vụ tốt, tư vấn chăm s&oacute;c kh&aacute;ch h&agrave;ng cực kỳ nhiệt t&igrave;nh v&agrave; c&oacute; t&acirc;m, sản phẩm tốt kh&ocirc;ng phải b&agrave;n c&atilde;i.</p></p>',
                'type' => 'customerfeedback',
                'blocks' => '{}',
                'status'    => 1,
                'thumbnail' => '/assets/images/avatar.jpg',
