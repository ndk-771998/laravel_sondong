...
class AdminPostControllerTest extends PostTypeTestCase
{
    use RefreshDatabase;
     ...
     * @test
     */
    public function can_create_about_post_by_admin_router()
    {
     ...
     * @test
     */
    public function can_update_about_post_by_admin_router()
    {
     ...
     * @test
     */
    public function can_delete_about_post_by_admin_router()
    {
